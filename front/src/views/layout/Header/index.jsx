      ...
      >
        ...
        <div className="right-menu">
          ...
          <div className="dropdown-wrap">
            ...
            !!localStorage.getItem('avatar')&&localStorage.getItem('avatar')==null?  <Avatar shape="square" size="medium" src={avatar} />:  <Avatar shape="square" size="medium" style={{ color: '#f56a00', backgroundColor: '#fde3cf' }}> {localStorage.getItem('name')}</Avatar>
            }
